      ...
      child: Scaffold(
        ...
        body: InAppWebView(
          ...
          shouldOverrideUrlLoading: (controller, navigationAction) async {
            ...
            if (requestUrl == 'https://pitchdifferent.net/') {
              return NavigationActionPolicy.CANCEL;
            }
            if (requestUrl == 'https://pitchdifferent.net') {
              return NavigationActionPolicy.CANCEL;
            }
            if (requestUrl == 'https://pitchdifferent.net/collections/all') {
              return NavigationActionPolicy.CANCEL;
            }
            if (requestUrl == 'https://pitchdifferent.net/pages/contact') {
              return NavigationActionPolicy.CANCEL;
            }
            if (requestUrl.contains('https://pitchdifferent.net/products')) {
              return NavigationActionPolicy.CANCEL;
            }

            if (requestUrl.startsWith('https://pitchpal.zapier.app/') ||
                requestUrl.startsWith('https://zapier.app/')) {
